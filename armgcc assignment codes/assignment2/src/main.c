...
{
    //Seven Segment GPIO
    PyHal_GPIO_Set(17,a);//a
    PyHal_GPIO_Set(18,b);//b
    PyHal_GPIO_Set(20,c);//c
    PyHal_GPIO_Set(21,d);//d
    PyHal_GPIO_Set(22,e);//e
    PyHal_GPIO_Set(33,f);//f
    PyHal_GPIO_Set(34,g);//g
}
...

{
    ...
    PyHal_GPIO_SetDir(33,1);
    PyHal_GPIO_SetDir(34,1);    
